...
//================================================
//      Implementation of shift table operations.
//================================================
...
//      then output, in particular with hardware acceleration.
...
//      other will become memory leak.
      ...
      pow [0] = 0;                     // Get square by code below.
      if (np <= MAX_SMP_IN)
        pow [0].addmulsmp
